...
pastData = client.get_historical_klines("BTCUSDT", Client.KLINE_INTERVAL_15MINUTE, limit=1, klines_type=HistoricalKlinesType.FUTURES)
pastData1 = client.get_historical_klines("BTCUSDT", Client.KLINE_INTERVAL_15MINUTE, limit=1)
#
print(pastData)
print(pastData1)
